...
public class Paddle : MonoBehaviour
{
    ...
    // freeze flag to control when to start moving or not moving paddles 
    bool frozen;
    // instance of the Timer class to access its funcitonality
    protected Timer freezerTimer;
    ...
    void Start()
    {
        ...
        freezerTimer.Duration = ConfigurationUtils.FreezeTimer;
    }
    ...
    void OnCollisionEnter2D(Collision2D coll)
    {
        ...
        //if (coll.gameObject.CompareTag("Freezer"))
        //{
        //    print("freeze u");
        //}
    }
